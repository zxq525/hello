...
class image
{
    ...
    function __construct()
    {
		global $PHPCMS;
		$this->thumb_enable = 1;
		$this->watermark_enable = 0;
		$this->set(300, 300, 100, 100);
    }
	...
	function set($w_minwidth = 300, $w_minheight = 300, $w_quality = 100, $w_pct = 100)
	{
    ...
    function info($img) 
	{
		...
		//echo substr(strrchr($abc, "."), 1)."<
		$imagetype = strtolower($this->imgtype($imageinfo[2]));
