function atCalendarControl(){
  ...
  this.addCalendarPad=function(){
   document.write("<div id='divCalendarpad' style='position:absolute;top:100px;left:0;width:255px;height:187px;display:none;'>");
   document.write("<iframe frameborder=0 height=189 width=250></iframe>");
   document.write("<div style='position:absolute;top:2px;left:2px;width:250px;height:187px;background-color:#336699;'></div>");
   document.write("</div>");
  ...
  this.addCalendarBoard=function(){
   ...
   divBoard.style.cssText="position:absolute;top:0;left:0;width:250px;height:187px;border:0 outset;background-color:buttonface;";

   var tbBoard=document.createElement("table");
   divBoard.insertAdjacentElement("beforeEnd",tbBoard);
   tbBoard.style.cssText="position:absolute;top:1px;left:1px;width:250px;height:10px;font-size:9pt;";
  ...
  /************** 设置各功能按钮的功能 *********************/
   ...
   tbBody.style.cssText="position:relative;top:0;left:0;width:248px;height:103px;font-size:9pt;"
...
/************** 加入功能按钮公共样式 *********************/
  ...
  this.show=function(targetObject,returnTime,defaultDate,sourceObject){
   ...
   if((defaultDate==undefined) || (defaultDate=="")){
	...
	if(defaultDate.match(Datereg)) defaultDate=defaultDate+" "+calendar.today[3]+":"+calendar.today[4]+":"+calendar.today[5];
