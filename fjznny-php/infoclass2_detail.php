...
$class=$db->fetch_first("SELECT * FROM {$dbtablepre}article_class where id=". (int)$detail['classid'] ." AND classpage='infoclass2' limit 1");
if(!$class){
	jsalert("没有找到相关信息，请重试；","back","window");
}
?>
...
<div id="mainWrapper">
<div class="title_pos">
<h3><?php echo $class['classname'];?></h3><div class="position">当前位置：<a href="./">首页</a> &gt; <a href="infoclass2.php?classid=<?php echo $class['id'];?>"><?php echo $class['classname'];?></a> &gt; 信息正文</div>
</div>
<div class="clear"></div>
