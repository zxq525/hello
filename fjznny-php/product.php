...
?>
      <li><div class="topic"><a href="product_detail.php?id=<?php echo $rs['id'];?>" target="_blank"><?php echo $rs['topic'];?></a></div><div class="date"><?php echo date('Y-m-d',$rs['joindate']);?></div></li>
<?php
	$i++;
}
?>
